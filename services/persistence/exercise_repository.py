...
@st.cache_resource # Cache the connection to reuse across Streamlit reruns
def _get_connection() -> sqlite3.Connection:
    conn = sqlite3.connect(_DB_PATH, check_same_thread=False) # Allow sharing connection across threads
